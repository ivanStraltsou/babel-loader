...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = 'test.html';
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, "<div>Hello World!</div>") }]);
	module.exports = path;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = 'C:/Users/Toby/dev/ngtemplate-loader/test/src/test.html';
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, "<div>Hello World!</div>") }]);
	module.exports = path;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = 'C:/Users/Toby/dev/ngtemplate-loader/test/src/test.html';
	window.angular.module('testModule').run(['$templateCache', function(c) { c.put(path, "<div>Hello World!</div>") }]);
	module.exports = path;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var path = '/prefixC:/Users/Toby/dev/ngtemplate-loader/test/src/test.html';
	window.angular.module('ng').run(['$templateCache', function(c) { c.put(path, "<div>Hello World!</div>") }]);
	module.exports = path;
